...
def train():
  ...
  with g1.as_default():
    ...
    train_op = cifar10.train_part2(loss, global_step, grads)
    ...
    with tf.train.MonitoredTrainingSession(
     ...
     # h = mon_sess.partial_run_setup([grads, train_op], [global_step, images, labels, logits, loss])
     
      while not mon_sess.should_stop():
        gradients = mon_sess.run([grads,increment_global_step_op])
        #res = mon_sess.run(train_op) 
